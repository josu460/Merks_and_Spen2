...
class ModificacionUsuario_U:
    ...
    def create_widgets(self):
        Label(self.frame, text="Modificación de tu usuario", fg="blue", font=("modern", 18)).pack() 
        Label(self.frame, image=self.image).pack()
        Label(self.frame, text="Solo puedes modificar tu usuario y contraseña", fg="black", font=("arial", 8)).pack()
...
if __name__ == "__main__":
    ...
    app = ModificacionUsuario_U(frame)
    root.mainloop()
