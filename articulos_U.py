...
class BuscadorArticulos:
    ...
    def __init__(self, ventana):
        ...
        self.boton_generar_ticket = Button(frame_buscador, text="Generar Ticket", height=2, width=15, bg="blue", fg="white", font=("Comic Sans", 10, "bold"), command=self.generar_ticket)
...
if __name__ == '__main__':
    ventana = Tk()
    aplicacion = BuscadorArticulos(ventana)
    ventana.mainloop()